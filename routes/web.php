...
Route::get('/admin/bast/{bast}/print', function (Bast $bast) {
    ...
    <head>
        ...
        <style>
            ...
            .header-surat { text-align: center; margin-bottom: 15px; font-weight: bold; text-transform: uppercase; }
            .content { text-align: justify; }
            .signature-table { width: 100%; border-collapse: collapse; text-align: center; margin-top: 20px; }
            .sign-img { height: 70px; width: auto; display: block; margin: 0 auto; }
        </style>
    </head>
    <body onload="window.print()">
        <div class="header-surat"><h3>BERITA ACARA SERAH TERIMA</h3><p>NOMOR: '.$bast->number.'</p></div>
        <div class="content">
            <p>PARA PIHAK sepakat melaksanakan serah terima pekerjaan <strong>'.$bast->project_title.'</strong>.</p>
            <table class="signature-table">
                <tr><td width="50%">PIHAK KEDUA</td><td width="50%">PIHAK PERTAMA</td></tr>
                <tr><td height="70"></td><td>'. ($signBase64 ? '<img src="'.$signBase64.'" class="sign-img">' : '') .'</td></tr>
