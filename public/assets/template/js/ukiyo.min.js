!function(t, e) {
    ...
    n.prototype.setStyle = function(t) {
        ...
        "0px" === n.marginTop && "0px" === n.marginBottom || (r.marginTop = n.marginTop,
        r.marginBottom = n.marginBottom,
        a.marginTop = "0",
        a.marginBottom = "0"),
        "auto" !== n.inset && (r.top = n.top,
        r.right = n.right,
        r.bottom = n.bottom,
        r.left = n.left,
        a.top = "0",
        ...
        "auto" !== n.gridArea && "auto / auto / auto / auto" !== n.gridArea && (r.gridArea = n.gridArea,
        a.gridArea = "auto"),
        t && (r.width = "100%",
        r.overflow = "hidden",
        a.display = "block",
        ...
        "0px" !== n.borderRadius && (r.borderRadius = n.borderRadius,
        r.isolation || (r.isolation = "isolate"),
        "0px" !== n.marginLeft && (r.marginLeft = n.marginLeft,
        a.marginLeft = "0"),
        "0px" !== n.marginRight && (r.marginRight = n.marginRight,
        a.marginRight = "0"),
        r.width = i + "px"),
        o && (r.width = i + "px",
        a.width = "100%"),
        "none" !== n.maxHeight && (r.maxHeight = n.maxHeight,
        a.maxHeight = "none"),
        "0px" !== n.minHeight && (r.minHeight = n.minHeight,
        a.minHeight = "none"),
        a.width = i + "px",
    ...
    n.prototype.onLeave = function() {
        var t = this.element;
        this.options.willChange && "transform" === t.style.willChange && (t.style.willChange = ""),
        this.isVisible = !1
    }
    ,
    ...
    n.prototype.reset = function() {
        ...
        e.bottom = "",
        e.left = ""),
        "none" !== t.transform && (t.transform = "",
        e.transform = ""),
        "auto" !== t.zIndex && (t.zIndex = ""),
        "0px" !== t.borderRadius && (t.borderRadius = "",
        t.isolation = ""),
        this.setStyle(),
        this.applyParallax()
    }
    ...
    var o = function(e, i) {
        ...
        n && o && "IntersectionObserver"in window && this.init(function(e) {
